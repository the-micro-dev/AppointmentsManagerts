        ...
        <div style={{margin:"inherit"} }>
            ...
            <input
                ...
                <section>
                    ...
                    <select name="value1" id="cars">
                        <option value="ACQ METH">ACQ METH</option>
                        <option value="APRV CODE">APRV CODE</option>
                        <option value="ATHY DATE">ATHY DATE</option>
                        <option value="CPVOIDS">CPVOIDS</option>
                        <option value="CURFY">CURFY</option>
                        <option value="DTO_METHOD">DTO_METHOD</option>
                        <option value="EMLSERVER">EMLSERVER</option>
